...
export const dialogEn = {
    ...
    dialogSingleDrawLimit: `The maximum quantity for a single extraction is ${SINGLE_TIME_MAX_PERSON_COUNT}`,
...
export const dialogZhCn = {
    ...
    dialogSingleDrawLimit: `单次抽取数量上限为 ${SINGLE_TIME_MAX_PERSON_COUNT}`,
